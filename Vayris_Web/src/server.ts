...
export class VayrisServer {
  ...
  constructor(orchestrator: AgentOrchestrator, toolContext: ToolContext, permissionManager: any, memoryStore: MemoryStore, appPath: string = process.cwd(), port: number = 3000) {
  ...
  private setupOrchestratorEvents() {
    ...
    this.permissionManager.onRequest((reqId: string, req: any) => {
