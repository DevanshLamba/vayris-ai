...
Vayris contains a local knowledge base for:
* project documentation
* system architecture
* user-provided knowledge
* indexed documents

The knowledge base is local and not part of the Git repository's generated vector database.


## Productivity

Vayris provides local:
* Tasks
* Reminders
* Alarms
* Scheduling
...
Productivity in Vayris is local-first. No Google is required, and no email is automatically sent. Email drafts are displayed directly in the chat for manual copying. Local reminders and alarms are machine-local and use Windows notifications. Phone synchronization is not currently implemented.
